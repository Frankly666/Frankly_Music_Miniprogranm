...
__DEFINE__(1719127071442, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1719127071443,"./event-store":1719127071444}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1719127071443, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1719127071444, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1719127071443,"./utils":1719127071445}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1719127071445, function(require, module, exports) {
...
return __REQUIRE__(1719127071442);
})()
